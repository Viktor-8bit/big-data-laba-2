...
# street и building_number

addresses = [
    Addreses(1, "Saint Petersburg", "Пушкина", "25", "3", "10", "Entrance on the right"),
    ...
    Addreses(7, "Berlin", "Пушкина", "25", "-", "3", "Service entrance"),
    ...
    Addreses(16, "Barcelona", "Мира", "25", "Floor 2", "Door 7", "Secret entrance"),
]

# Производители id [0 - 15]
manufacturers = [ 
    Manufacturers(0, "AyOosdfsdfM"), 
    ...
    Manufacturers(10, "ArOaM"), 
    Manufacturers(11, "ArOaMp"), 
    Manufacturers(12, "McDonald's"),
    Manufacturers(13, "AyOosdfsdfM"), 
...
categories = [
    ...
    Category(8, "Printer"),
    Category(9, "Monitor"),
    Category(10, "Enchanted Elixirs"),
    Category(11, "Whimsical Wizardry"),
    Category(12, "Mouse"),
    Category(13, "Celestial Confections"),
...
for i in range(15):
    ...
    stores.append(store)
    last_id = i
stores.append(Store(last_id + 1, "Мира 25 магазин", addresses[15]))
...
end_date = datetime(2024, 3, 31)
for p in products:
    purchases.append(Purchase(id, random.randint(10, 100) / 100, f"{random_date.year}-{random_date.month}-{random_date.day}", customers[3], random.choice(stores))) 
    id += 1
for p in products:
    purchases.append(Purchase(id, random.randint(10, 100) / 100, f"{random_date.year}-{random_date.month}-{random_date.day}", customers[6], random.choice(stores))) 
    id += 1


# покупка  с июня 2021 года 2021.6.X
purchase_id = id
purchases.append(Purchase(id, random.randint(10, 100) / 100, f"2021-06-01", customers[6], stores[15]))
...
purchasedelivery.remove(purchasedelivery[id - 1])
# доставка август 2021 года 2021.8.X
id += 1
purchasedelivery.append(PurchaseDelivery(id, f"2021-08-01", purchases[purchase_id]))
